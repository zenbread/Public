############################################################################ 
# This script, once executed, is designed to output a message, in bold letters
# This script is the property of the Cyber Training Center 
#############################################################################
...
for x in {5,18,24} do 
        ...
        echo 'Hopefully This Works !' >/dev/nulll
done  
