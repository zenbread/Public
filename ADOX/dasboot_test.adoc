...
image::../Linux_Exer_Resources/locked_grub.png["grub",height="100",width="350"] +
edit following file `/boot/grub/menu.lst`: +
image::../Linux_Exer_Resources/menu_lst.png["menu",height="133",width="405"]
...
image::../Linux_Exer_Resources/reboot.png["reboot",height="100",width="350"] +
edit following file `/etc/inittab`: +
image::../Linux_Exer_Resources/inittab.png["inittab",height="133",width="405"]
...
image::../Linux_Exer_Resources/kek.png["inttab",height="133",width="405"] +

image::../Linux_Exer_Resources/lel.png["inttab",height="133",width="405"] +

image::../Linux_Exer_Resources/redirect.png["inttab",height="133",width="405"] +

image::../Linux_Exer_Resources/art.png["art",height="133",width="405"] +
...
image::../Linux_Exer_Resources/intel.png["intel",height="133",width="405"] +
