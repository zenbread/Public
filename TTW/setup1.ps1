...
-Force:$true
Set-ItemProperty "HKLM:\Software\Microsoft\Windows\CurrentVersion\RunOnce" -name "setup2" -value 'C:\WINDOWS\system32\WindowsPowerShell\v1.0\powershell.exe -noprofile -File "C:\windows\system32\setup2.ps1"'
